...
# KChiu, 2022-Mar-27, Added codes to complete DataClasses module
#------------------------------------------#
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        ...
        """
        # TODone append individual track to cd_tracks list
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        while True:
            try:
                ...
                print('Track Index should be an Integer!\n')
                break
            try:# Dispaly an error when invalid track ID is selected
                if self.__cd_tracks[track_id - 1] == None:
                    print('No information in this Track! Try again!\n')
                    break
                else:
    ...
    def get_tracks(self) -> str:
        ...
        for track in self.__cd_tracks:
            if track is None:
                ...
                result += str(track) + '\n'
        # clear CD track list if all are NoneType filler tracks object resulted from sort_track().
        if len(self.__cd_tracks) == empty_rack:
            self.__cd_tracks.clear()
        else:
            return result
